...
/**
 * 该类也是继承了WrappedChannelHandler，增强功能，该类是把连接、断开连接以及接收到的消息都分发到线程池，
 * 但是不同的是，该类自己创建了一个跟连接相关的线程池，把连接操作和断开连接操分发到该线程池，逐个的执行
...
public class ConnectionOrderedChannelHandler extends WrappedChannelHandler {
    ...
    /**
     * 可以看到，connected与disconnected都是分发到连接线程池connectionExecutor中，和AllChannelHandle类r中的分发的线程池不是同一个。
     * 而ConnectionOrderedChannelHandler的received方法跟AllChannelHandle一样。
     * @param channel
