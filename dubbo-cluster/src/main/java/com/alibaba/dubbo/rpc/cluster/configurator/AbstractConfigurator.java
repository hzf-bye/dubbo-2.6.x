 ...
 * 可以参考官方文档：http://dubbo.apache.org/zh-cn/docs/user/demos/config-rule-deprecated.html
 *
 */
        ...
        if (Constants.ANYHOST_VALUE.equals(configuratorUrl.getHost()) || host.equals(configuratorUrl.getHost())) {
            ...
            if (configApplication == null || Constants.ANY_VALUE.equals(configApplication)
                ...
                for (Map.Entry<String, String> entry : configuratorUrl.getParameters().entrySet()) {
                    ...
                    /*
                     * 举例子如果configuratorUrl中指定了application为hzf，且当前提供者URL的application不为hzf那么直接返回此提供者URL，
                     * 因为application不相等则不覆盖此提供者的参数，
                ...
                // 来到这儿说明需要需改此提供者的参数列表，移除掉一些内置属性剩下的都覆盖。
                // 移除条件 KEYS 集合，并配置到 URL 中
                // configuratorUrl中剩余的参数覆盖当前提供者的参数
